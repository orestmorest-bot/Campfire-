// Hero — the moment. Supports three layouts and three headline copy variants via props.
// Layouts: "centered", "split", "minimal"
// Copy: "ghost-direct", "ghost-empathy", "ghost-question"

const HEADLINES = {
  "ghost-direct": {
    eyebrow: "▸ A NEW HOME FOR ROLEPLAY",
  ...
  "ghost-empathy": {
    eyebrow: "▸ BUILT FOR WRITERS WHO SHOW UP",
...
const Hero = ({ layout = "centered", headline = "ghost-direct", density = "relaxed" }) => {
  const copy = HEADLINES[headline] || HEADLINES["ghost-direct"];
  const pad = density === "compact" ? "72px 32px 56px" : "112px 32px 80px";
  if (layout === "split") return <HeroSplit copy={copy} pad={pad} density={density} />;
  if (layout === "minimal") return <HeroMinimal copy={copy} pad={pad} density={density} />;
  return <HeroCentered copy={copy} pad={pad} density={density} />;
};

// ── Centered: pixel headline + form below + waitlist counter readout ─────────
const HeroCentered = ({ copy, pad, density }) =>
<section id="top" style={{ position: "relative", padding: pad, overflow: "hidden" }}>
    ...
    <div style={{ maxWidth: 980, margin: "0 auto", position: "relative", textAlign: "center" }}>
      ...
      fontSize: density === "compact" ? 52 : 64, lineHeight: 1.12,
      ...
      <p style={{
      fontFamily: "var(--font-body)", fontSize: density === "compact" ? 17 : 19,
...
// ── Split: form on left, mocked-up app screen on right ───────────────────────
const HeroSplit = ({ copy, pad, density }) =>
<section id="top" style={{ position: "relative", padding: pad, overflow: "hidden" }}>
    <Scanlines />
    <EmberHaze />
    <div style={{
    ...
    display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 56, alignItems: "center"
      ...
      <div>
        ...
        <h1 style={{
        fontFamily: "var(--font-display)",
        fontSize: density === "compact" ? 44 : 52, lineHeight: 1.12,
        ...
        <p style={{
        fontFamily: "var(--font-body)", fontSize: density === "compact" ? 16 : 18,
        color: "var(--text-body)", lineHeight: 1.55,
        maxWidth: 520, margin: "24px 0 0", textWrap: "pretty"
      }}>
          {copy.sub}
        </p>
...
// ── Minimal: type-only, big, uncluttered ─────────────────────────────────────
const HeroMinimal = ({ copy, pad, density }) =>
<section id="top" style={{ position: "relative", padding: pad, overflow: "hidden" }}>
    <Scanlines />
    <div style={{ maxWidth: 920, margin: "0 auto", position: "relative", textAlign: "left" }}>
      ...
      <h1 style={{
      fontFamily: "var(--font-display)",
      fontSize: density === "compact" ? 56 : 72, lineHeight: 1.05,
      ...
      fontFamily: "var(--font-body)", fontSize: density === "compact" ? 17 : 19,
      color: "var(--text-body)", lineHeight: 1.55,
      maxWidth: 580, margin: "32px 0 0", textWrap: "pretty"
    }}>
        {copy.sub}
      </p>
...
<div style={{
  ...
  color: "var(--ember)", letterSpacing: "0.12em", textTransform: "uppercase"
    ...
    {HEADLINES["ghost-direct"].eyebrow.replace("▸ ", "")}
  </div>;
...
<div style={{
  marginTop: 48, display: "flex", justifyContent: align === "center" ? "center" : "flex-start"
}}>
    <div style={{
...
// "The ghost" — a session that died mid-scene. Realistic roleplay dialogue,
// then four days of nothing, then the user's unsent drafts piling up.
const HeroAppMock = () =>
<div style={{ position: "relative" }}>
    ...
    transform: "rotate(-1.5deg)"
      ...
      <div style={{ padding: 16 }}>
        ...
        paddingBottom: 12, borderBottom: "1px solid var(--border-subtle)" }}>
          ...
          fontFamily: "var(--font-mono)", fontSize: 13, color: "var(--ember)",
          fontWeight: 700 }}>WF</div>
          <div style={{ flex: 1 }}>
        ...
        {/* Their last message — long, beautiful, hooks you */}
        ...
        {/* Your reply — earnest, you put work in */}
        ...
        {/* Your follow-ups — sent but unread */}
        <div style={{ background: "rgba(255,107,61,0.06)",
        borderLeft: "2px solid var(--ember)", padding: "8px 10px", marginBottom: 5 }}>
          ...
          letterSpacing: "0.1em", marginBottom: 3, display: "flex", justifyContent: "space-between" }}>
            <span>YOU</span><span>TUE 8:14 AM · SENT ✓ · UNREAD</span>
          </div>
          <div style={{ fontSize: 12, color: "var(--text-body)", lineHeight: 1.5 }}>
            hey! no pressure but did my last reply land okay? happy to revise the tone if it was too much
          </div>
        </div>
        <div style={{ background: "rgba(255,107,61,0.06)",
        borderLeft: "2px solid var(--ember)", padding: "8px 10px", marginBottom: 5 }}>
          <div style={{ fontFamily: "var(--font-mono)", fontSize: 9, color: "var(--ember)",
          letterSpacing: "0.1em", marginBottom: 3, display: "flex", justifyContent: "space-between" }}>
            <span>YOU</span><span>WED 1:02 AM · SENT ✓ · UNREAD</span>
          </div>
          <div style={{ fontSize: 12, color: "var(--text-body)", lineHeight: 1.5 }}>
            i can rewrite scene 7 if you want a different direction. just let me know you're still in
          </div>
        </div>
        <div style={{ background: "rgba(255,107,61,0.06)",
        borderLeft: "2px solid var(--ember)", padding: "8px 10px", marginBottom: 12 }}>
          <div style={{ fontFamily: "var(--font-mono)", fontSize: 9, color: "var(--ember)",
          letterSpacing: "0.1em", marginBottom: 3, display: "flex", justifyContent: "space-between" }}>
            <span>YOU</span><span>FRI 3:41 AM · SENT ✓ · UNREAD</span>
          </div>
          <div style={{ fontSize: 12, color: "var(--text-body)", lineHeight: 1.5 }}>
            ok i get it. sorry for double-texting. hope you're okay.
          </div>
        </div>
        ...
        padding: "10px 12px" }}>
          <span style={{ fontSize: 13, color: "#5A4A3E", fontStyle: "italic", flex: 1 }}>
            Type a reply…
          </span>
          <span style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: "#5A4A3E",
    ...
    {/* Floating "ghosted" stamp — replaces the friendly reliability chip */}
    <div style={{
    ...
    {/* Floating note — hopeful, not scary */}
    <div style={{
